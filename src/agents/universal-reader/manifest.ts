    ...
    methods: [{
        ...
        args: [
            {
                name: 'fileBuffer',
                type: 'ArrayBuffer',
                description: 'Le contenu binaire du fichier à lire.'
            },
            {
                name: 'fileType',
                type: 'string',
                description: 'Le type MIME du fichier (ex: "application/pdf").'
            }
        ],
        ...
        returns: {
            ...
            properties: {
                fullText: {
                    type: 'string',
                    description: 'Le texte complet extrait.'
                },
                summary: {
                    type: 'string',
                    description: 'Un résumé du texte, si le document était trop long.'
                },
                wasSummarized: {
                    type: 'boolean',
                    description: 'Vrai si un résumé a été généré.'
                },
                metadata: {
                    type: 'object',
                    description: 'Informations sur le processus de lecture.'
                }
            }
        }
    }]
